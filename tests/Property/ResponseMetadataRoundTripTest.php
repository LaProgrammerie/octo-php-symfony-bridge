...
final class ResponseMetadataRoundTripTest extends TestCase
{
    ...
    public function headersArePreservedWithoutServerAndXPoweredBy(): void
    {
        ...
        $this->forAll(
            ...
            $headerNames = array_map(static fn (array $h) => $h[0], $facade->headers);
     ...
     */
    private static function safeHeaderValue(): Generator
    {
        return Generators::map(
            static fn (int $len): string => self::randomPrintableAscii(max(1, $len)),
 ...
 */
final class RecordingRawResponse
{
